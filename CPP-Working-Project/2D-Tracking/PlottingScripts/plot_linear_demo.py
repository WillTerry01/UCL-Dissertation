...
def main():
    ...
    fig1.savefig("../plots/trajectory_comparison.png", dpi=300, bbox_inches='tight')
    plt.close(fig1)
    ...
    fig2.savefig("../plots/velocity_comparison.png", dpi=300, bbox_inches='tight')
    plt.close(fig2)
    
    # Plot 3: Summary statistics
    print("Creating summary statistics plot...")
    fig3 = plot_summary_statistics(data)
    fig3.savefig("../plots/summary_statistics.png", dpi=300, bbox_inches='tight')
    plt.close(fig3)
    ...
    for run_idx in range(num_runs):
        ...
        fig.savefig(f"../plots/trajectory_run_{run_idx+1}.png", dpi=300, bbox_inches='tight')
        plt.close(fig)
